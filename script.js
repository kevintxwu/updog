...
function newCardUp(alt) {
  $(".pos").css("display", "initial");
  if (alt == 0) {
    $("#card-alt").css("top", "100%");
    $("#card-main").animate({top:("-100%")}, 500);
    $("#card-alt").animate({top:("0")}, 500);
  } else {
    $("#card-main").css("top", "100%");
    $("#card-alt").animate({top:("-100%")}, 500);
    $("#card-main").animate({top:("0")}, 500);
  }
  setTimeout(function(){$(".pos").css("display", "none");}, 300);
}
function newCardDown(alt) {
  $(".neg").css("display", "initial");
  if (alt == 0) {
    $("#card-alt").css("top", "-100%");
    $("#card-main").animate({top:("100%")}, 500);
    $("#card-alt").animate({top:("0")}, 500);
  ...
  setTimeout(function(){$(".neg").css("display", "none");}, 300);
}
function submit() {
